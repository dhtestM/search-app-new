...
export default class VideoResults extends React.Component {
  ...
  render() {
  console.log("searchREsults Video=", this.props.results);
  	return(
  	 <div>
	    <div className="Header">
	    	<h4>Video Results <span className="NumResults">({this.state.results.length})</span>
        	</h4>
    	</div> 
		  ...
		  {(array) => (
		     array.map((item, i) => (
		        <VideoResult item={item} index={i} searchIndex={this.props.searchIndex} /> 
		     )
		  ))}
		</ShowMoreResults>
	</div>
