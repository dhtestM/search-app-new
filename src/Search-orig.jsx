...
class Search extends React.Component {
  ...
  renderSearchBlock = (searchTextVal) => {
    ...
    return (<ClickAwayListener onClickAway={this.handleClickAway}><Modal open={this.state.isOpen} contentLabel="Search" onClose={this.onClose}>
      <Grid className="searchPanelContainer" style={{ tempStyle }} container grid-container--fit spacing={8}>
        <Grid item xs={6} direction="column" >
          <Paper className="searchPanel primary justify-xs-flex-start" elevation={0}>
             {this.renderInput()}
